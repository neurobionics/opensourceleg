...
This Code of Conduct is adapted from the `Contributor Covenant <https://www.contributor-covenant.org>`_, version 1.4, available `here <https://www.contributor-covenant.org/version/1/4/code-of-conduct.html>`_.

For answers to common questions about this code of conduct, read `more <https://www.contributor-covenant.org/faq>`_.

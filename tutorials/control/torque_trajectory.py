...
if __name__ == "__main__":
    ...
    with actuator, encoder:
        ...
        for t in clock:
            ...
            torque_logger.info(f"t: {t}, torque_sp: {torque_sp}, output_torque: {actuator.joint_torque}, winding_temperature: {actuator.winding_temperature}")
